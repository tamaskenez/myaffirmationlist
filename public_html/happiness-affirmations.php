...
<html>
<head>
  <title>Happiness Affirmations</title>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="keywords" content="happiness affirmation images, happiness affirmations, happiness, positive, thoughts, attraction">
  <meta name="description" content="Beautiful affirmation images and affirmations about happiness.">
  ...
  <link rel="canonical" href="https://www.myaffirmationlist.com/happiness-affirmations.php" />
...
<!--photo header-->
    <div class="row">
      ...
      <div class="col-xs-12 col-md-8"><img src="pics/happiness.png" alt="Happiness Affirmations" class="img-responsive"/></div>
      <div class="col-md-2"><p></p></div>
    </div>
...
<div class="row">
    <div class="col-md-2"><p></p></div>
    <div class="col-md-8">
    <h1>More Happiness Affirmations:</h1>
    </div>
    <div class="col-md-2"><p></p></div>
</div>
<div class="row">
    ...
    <div class="col-md-8">
      ...
      <ul>
        <li>I am happy and content.</li>
        <li>I am grateful for my happy life.</li>
        <li>I deserve a happy life.</li>
        <li>I naturally attract joy and happiness.</li>
        <li>I can see the good in everything.</li>
        <li>I do only things that makes me happy.</li>
        <li>I always find a reason to smile.</li>
        <li>I am determined to be cheerful and happy in whatever situation I may find myself. (Martha Washington)</li>
        <li>I bring joy and happiness to people surrounding me.</li>
        <li>Helping people makes me happy.</li>
        <li>I am in harmony with myself. It is easy for me to be happy.</li>
        <li>I love and I am loved and this is the greatest happiness in the world.</li>
        <li>I live every minute with grace, gratitude and happiness.</li>
        <li>I am getting happier and happier in every minute of my life.</li>
        <li>I choose to be happy.</li>
        <li>My happiness makes every people surrounding me happy.</li>
        <li>Accepting challenges makes me happy. It brings me towards my goals.</li>
        <li>I always look at the bright side of life.</li>
        <li>God blessed me with happiness for my whole life.</li>
        <li>My positive attitude brings me happiness.</li>
        <li>I accept happiness that is coming into my life right now.</li>
        <li>My self-confidence makes me happy.</li>
        <li>I have an excellent sense of humor.</li>
        <li>I have been given endless happiness.</li>
        <li>I am very happy to be who I am.</li>
        <li>My job provides me a very happy life.</li>
        <li>I handle everything with ease and joy.</li>
        <li>Everything is OK around me.</li>
        <li>Playing is my life. Challenges are just another maze to solve.</li>
        <li>I am nurturing my inner child with play and joy.</li>
        <li>I feel happiness flowing towards me.</li>
        <li>The Universe provides me so much happiness that I can easily share with others.</li>
        <li>I smile at everyone. My smiles generates very much happiness in the world.</li>
        <li>I like entertaining other people. It makes me very happy.</li>
        <li>I am very thankful for God for the happiness I get.</li>
        <li>Forgiving everybody washes bitterness out of me so there is more space for happiness.</li>
        <li>Playing with my children makes me very happy.</li>
        <li>I am very glad that I am healthy.</li>
        <li>My everyday job makes me very happy and contented.</li>
        <li>Excercising always releases endorphins in me that makes me feel very happy.</li>
        <li>My affirmations are working right now. I am happy.</li>
        <li>Everybody notices how happy I am.</li>
        <li>Happiness makes me look beautiful.</li>
