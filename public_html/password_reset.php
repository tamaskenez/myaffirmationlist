...
elseif($login->password_reset_mail_successfully_sent == true) {

    // show the request-a-password-reset or type-your-new-password form
   include("views/passwordresetsuccessful.php");
}
elseif($login->password_reset_failed_but_link_was_valid == true){
    $login->password_reset_link_is_valid = true;
    include("views/password_reset2.php");
}
else {
    // show the request-a-password-reset or type-your-new-password form
