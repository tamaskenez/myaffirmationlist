...
<html>
<head>
  <title>Career Affirmations</title>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="keywords" content="career affirmation images, carreer affirmations, affirmations, positive, thoughts, attraction">
  <meta name="description" content="Beautiful affirmation images and affirmations about career and work.">
...
<div class="row">
    <div class="col-md-2"><p></p></div>
    <div class="col-md-8">
    <h1>More Career Affirmations:</h1>
    </div>
    <div class="col-md-2"><p></p></div>
</div>
...
<div class="row">
		...
		<div class="col-md-8">
			<ul>
          <li>My collegues love to work with me.</li>
          <li>My boss is satisfied with my work.</li>
          <li>I am very creative and I have no fear to make my new ideas real.</li>
          <li>My businesses are successful.</li>
          <li>I am a good and respected negotiator.</li>
          <li>I am an excellent teamworker and very good in brainstormings.</li>
          <li>My salary is increasing as my boss appreciates my hard work and creativity.</li>
          <li>I do everything I can for my business.</li>
          <li>I am an excellent entrepreneur.</li>
          <li>I enjoy my job.</li>
          <li>Self-discipline is very important for me.</li>
          <li>I have qualities which enable me to be extremely successful.</li>
          <li>I can make the world a better place with my job.</li>
          <li>My professional reputation is excellent.</li>
          <li>I learn from every failure.</li>
          <li>I deserve to be paid well.</li>
          <li>I deserve to do the job what I really enjoy.</li>
          <li>I am reliable, everyone knows they can trust me. (nyelvtan?)</li>
          <li>I have a problem-solver attitude. (nyelvtan)</li>
          <li>I can conquer any challenges.</li>
          <li>My communication skills are excellent. I am able to tell my opinion in a clear and understandable way.</li>
          <li>I have the right to choose a meaningful and interesting job.</li>
          <li>My business is growing in every passing minute.</li>
          <li>My customers know (that) they can trust me. (nyelvtan?)</li>
          <li>I am the best salesman. I can sell everything to everyone. (nyelvtan Ès egyÈbkÈnt is nem g··z?)</li>
          <li>My computer/communication/negotiation skills are developing constantly.</li>
          <li>I find my work very fulfilling.</li>
          <li>My customers feel that I love them and they are going to choose my services next time again.</li>
          <li>My work-life balance is very healthy. (healthy?)</li>
          <li>I am able to get my dreamjob.</li>
          <li>Job interviews are easy for me. This enables me to get the most suitable job for me.</li>
          <li>I attract success naturally.</li>
          <li>My job is my life. I enjoy every moment of my work.</li>
          <li>My work brings joy to everybody.</li>
          <li>I am excellent at my job. This ensures me abundance and wealth.</li>
          <li>I am a great analyst.</li>
          <li>My boss trusts me. My work is appreciated.</li>
          <li>My boss loves the way I work.</li>
          <li>I maintain a good life-work balance.</li>
