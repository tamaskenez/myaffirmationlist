...
<html>
<head>
  <title>Learning Affirmations</title>
  <meta charset="utf-8">
...
<div class="row">
    ...
    <div class="col-md-8">
      ...
      <li>My memory is better and better in every minute.</li>
        <li>I like learning new things.</li>
        <li>Learning new things bring me joy.</li>
        <li>Learning new things brings me prosperity.</li>
        <li>I like practicing new things. Practice makes me perfect.</li>
        <li>I love learning. I love something new every day.</li>
        <li>My learning skills are getting better and better every day.</li>
        <li>The more I know about the world, theeasier I learn new things.</li>
        <li>My brain has a huge capacity and I am willing to use the whole of it.</li>
        <li>I love history! It teaches me about the past and I am going to use this knowledge to make my future better.</li>
        <li>I love geography! It is so interesting to learn more about places where other people lives.</li>
        <li>I love chemistry. It is so interesting how anyagok react with each other.</li>
