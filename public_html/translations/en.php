...
define("MESSAGE_ACCOUNT_NOT_ACTIVATED", "Your account is not activated yet. <br />Please click on the confirm link in the mail.");
...
define("MESSAGE_EMAIL_ALREADY_EXISTS", "This email address is already registered. <br /> Please use the \"I forgot my password\" page if you don't remember it.");
define("MESSAGE_EMAIL_CHANGE_FAILED", "Sorry, your email changing failed.");
define("MESSAGE_EMAIL_CHANGED_SUCCESSFULLY", "Your email address has been changed successfully. <br /> New email address is ");
...
define("MESSAGE_EMAIL_SAME_LIKE_OLD_ONE", "Sorry! <br /> That email address is the same as your current one. <br />Please choose another one.");
...
define("MESSAGE_PASSWORD_CHANGE_FAILED", "Sorry! <br />Your password changing failed.");
...
define("MESSAGE_PASSWORD_RESET_MAIL_FAILED", "Password reset mail NOT successfully sent!<br /> Error: ");
...
define("MESSAGE_PASSWORD_WRONG_3_TIMES", "You have entered an incorrect password 3 or more times already.<br /> Please wait 30 seconds to try again.");
define("MESSAGE_REGISTRATION_ACTIVATION_NOT_SUCCESSFUL", "Sorry, no such id/verification code combination here");
define("MESSAGE_REGISTRATION_ACTIVATION_SUCCESSFUL", "Activation was successful! <br />You can now log in!");
define("MESSAGE_REGISTRATION_FAILED", "Sorry, your registration failed. <br />Please go back and try again.");
define("MESSAGE_RESET_LINK_HAS_EXPIRED", "Your reset link has expired. <br />Please use the reset link within one hour.");
define("MESSAGE_VERIFICATION_MAIL_ERROR", "Sorry!<br />We could not send you an verification mail.<br />Your account has NOT been created.");
define("MESSAGE_VERIFICATION_MAIL_NOT_SENT", "Verification Mail NOT successfully sent! <br />Error: ");
define("MESSAGE_VERIFICATION_MAIL_SENT", "Your account has been created successfully <br />and we have sent you an email. <br />Please click the VERIFICATION LINK within that mail.");
...
define("MESSAGE_USERNAME_CHANGED_SUCCESSFULLY", "Your username has been changed successfully. <br />New username is ");
define("MESSAGE_USERNAME_EMPTY", "Username field was empty");
define("MESSAGE_USERNAME_EXISTS", "Sorry, that username is already taken. <br />Please choose another one.");
define("MESSAGE_USERNAME_INVALID", "Username does not fit the name scheme: <br />only a-Z and numbers are allowed, 2 to 64 characters");
define("MESSAGE_USERNAME_SAME_LIKE_OLD_ONE", "Sorry!<br /> That username is the same as your current one. <br />Please choose another one.");
...
define("WORDING_REGISTRATION_EMAIL", "User's email <br />(please provide a real email address, you'll get a verification mail with an activation link)");
...
define("WORDING_REQUEST_PASSWORD_RESET", "Request a password reset. <br /> Enter your e-mail address<br />and you'll get a mail with instructions:");
